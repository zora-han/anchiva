...
function tab(idName){
    ...
    var intrusion={
        ...
        'cur_page':1,		/*当前页号*/
        'data':[			/*当前页中的数据*/
            {id:0,name:"策略1",feature:"启用/未启用 （1800/200）",reference:10,matching:8},
            ...
            {id:3,name:"策略3",feature:"启用/未启用 （1800/75）",reference:36,matching:29},
            {id:4,name:"策略4",feature:"启用/未启用 （1800/500）",reference:48,matching:40},
            {id:5,name:"策略2",feature:"启用/未启用 （1800/350）",reference:52,matching:39},
            {id:6,name:"策略5",feature:"启用/未启用 （1800/680）",reference:11,matching:6},
            {id:7,name:"策略1",feature:"启用/未启用 （1800/66）",reference:67,matching:52},
            {id:8,name:"策略4",feature:"启用/未启用 （1800/82）",reference:5,matching:4},
            {id:9,name:"策略5",feature:"启用/未启用 （1800/94）",reference:24,matching:18},
            {id:10,name:"策略1",feature:"启用/未启用 （1800/200）",reference:10,matching:8},
            {id:11,name:"策略2",feature:"启用/未启用 （1800/300）",reference:15,matching:11},
            {id:12,name:"策略3",feature:"启用/未启用 （1800/150）",reference:20,matching:10},
            {id:13,name:"策略3",feature:"启用/未启用 （1800/75）",reference:36,matching:29},
            {id:14,name:"策略4",feature:"启用/未启用 （1800/500）",reference:48,matching:40},
            {id:15,name:"策略2",feature:"启用/未启用 （1800/350）",reference:52,matching:39},
            {id:16,name:"策略5",feature:"启用/未启用 （1800/680）",reference:11,matching:6},
            {id:17,name:"策略1",feature:"启用/未启用 （1800/66）",reference:67,matching:52},
            {id:18,name:"策略4",feature:"启用/未启用 （1800/82）",reference:5,matching:4},
            {id:19,name:"策略5",feature:"启用/未启用 （1800/94）",reference:24,matching:18}
        ]
    };
    //特例主机
    var exceptions={
        ...
        'cur_page':1,		/*当前页号*/
        'data':[			/*当前页中的数据*/
            {id:0,type:"类别1",featureID:"111.111.111.111",featureName:"特征1",exceptionId:"102.103.104.105"},
            {id:1,type:"类别2",featureID:"222.222.222.222",featureName:"特征5",exceptionId:"203.201.204.206"},
            {id:2,type:"类别3",featureID:"255.255.255.255",featureName:"特征3",exceptionId:"111.100.122.133"},
            {id:3,type:"类别3",featureID:"231.231.231.231",featureName:"特征7",exceptionId:"200.203.103.105"},
            {id:4,type:"类别4",featureID:"192.253.103.101",featureName:"特征6",exceptionId:"192.111.102.103"},
            {id:5,type:"类别2",featureID:"168.111.222.101",featureName:"特征2",exceptionId:"172.103.108.106"},
            {id:6,type:"类别5",featureID:"172.205.146.235",featureName:"特征8",exceptionId:"189.111.125.167"},
            {id:7,type:"类别1",featureID:"136.144.120.156",featureName:"特征3",exceptionId:"168.135.102.160"},
            {id:8,type:"类别4",featureID:"187.125.136.111",featureName:"特征5",exceptionId:"172.144.156.189"},
            {id:9,type:"类别5",featureID:"160.130.120.110",featureName:"特征4",exceptionId:"130.146.178.156"},
            {id:10,type:"类别1",featureID:"158.145.120.135",featureName:"特征8",exceptionId:"168.130.176.145"},
            {id:11,type:"类别2",featureID:"145.100.246.238",featureName:"特征3",exceptionId:"122.135.168.197"},
            {id:12,type:"类别3",featureID:"100.100.100.100",featureName:"特征5",exceptionId:"132.100.155.165"},
            {id:13,type:"类别3",featureID:"100.255.230.245",featureName:"特征6",exceptionId:"189.106.105.132"},
            {id:14,type:"类别4",featureID:"192.175.146.130",featureName:"特征1",exceptionId:"176.189.146.134"},
            {id:15,type:"类别2",featureID:"172.163.145.111",featureName:"特征2",exceptionId:"172.199.158.137"},
            {id:16,type:"类别5",featureID:"168.195.126.135",featureName:"特征8",exceptionId:"192.100.148.159"},
            {id:17,type:"类别1",featureID:"136.146.178.199",featureName:"特征3",exceptionId:"186.135.107.109"},
            {id:18,type:"类别4",featureID:"172.130.194.168",featureName:"特征6",exceptionId:"111.156.130.178"},
            {id:19,type:"类别5",featureID:"168.177.163.140",featureName:"特征9",exceptionId:"172.109.104.245"}
        ]
    };
    switch (idName){
...
function addData(name){
    var tabName=tab(name),
        str="",c=name.charAt(name.length-1), r;
    if(name==="exceptions"){
        $.each(tabName.data,function(i,n){
            ...
            +n.featureName+'</td><td>'
            +n.type+'</td><td>'
            +n.exceptionId+'</td><td><input type="checkbox"/></td>'
            +'<td><img src="imgs/9.png" alt=""/></td>'
            +'<td><img src="imgs/3.png" alt=""/></td>'
            +'<td><img src="imgs/4.png" alt=""/></td>'
            +'</tr>';
        });
        ...
        $.each(tabName.data,function(i,n){
            str+='<tr><td>'
            +(n.id+1)+'</td><td><a href="#attack-system-analysis">'
            +n.ip+'</a></td><td>'
            +n.account+'</td></tr>';
        });
