...
function addData(name){
    ...
    if(name==="basicCharacteristics"){
        ...
        $.each(tabName,function(i,n){
            str+='<tr><td><input type="checkbox"/></td><td  data-name="name">'
            +n.name+'</td><td><img src="imgs/icon03.png" alt=""/></td><td>'
            +n.url+'</td><td>'
            +n.type+'</td><td>'
            +n.submit+'</td><td>'
            +n.state+'</td>'
...
var setting = {
    ...
    selectButton1=$("#application-characteristics .form-inline button"),
    value,zTree,
    key = $("#typeTreeSearch"),
...
function searchNodes() {
    if($(this).parents(".portlet").find("#treeType")[0]===$("#treeType")[0]){
        zTree = $.fn.zTree.getZTreeObj("treeType");
