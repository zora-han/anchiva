...
$(document).ready(function () {
    ...
    $(".sub-menu>.nav-item a").click(function (e) {
        ...
        switch (href){
            ...
            //监控状态-流量统计
            case "#traffic-statistics":content.load("data/condition-monitoring/traffic-statistics.html");break;
            //监控状态-WAF
            case "#WAF":content.load("data/condition-monitoring/WAF/WAF.html");break;
            //安全策略-策略引用
            case "#policy-references":content.load("data/security-policy/policy-references/policy-references.html");break;
            //安全策略-入侵防护策略
    ...
    window.addEventListener("resize", function(){
        ...
        $("#bg-screen").height($(window).height());
    });
    ...
    document.onkeydown=function(event){
        ...
        if(e && e.keyCode==27 && $("#bg-screen").css("display")==="block"){ // 按 Esc
            $("#bg-screen").hide()
                .empty()
                .siblings("div").show();
