    ...
    //1.4系统状态
        ...
        function hInformation(){
            ...
            function addData(shift) {
                date.push(now.toLocaleTimeString().replace(/^\D*/,''));
                data.push((Math.random()*80+10)^0);
                data1.push((Math.random()*80+10)^0);
                if (shift) {
                    date.shift();
                    data.shift();
                    data1.shift();
                }
                now = new Date(+new Date(now) + oneHours);
            }
            for (var i = 0; i < 7; i++) {addData();}
            optionHInformation = {
                tooltip: {
                    trigger: 'axis'
                },
            ...
            HInformationChart.timeTicket = setInterval(function () {
                addData(true);
        ...
        //1.4.2会话信息
            ...
            function httpConcurrent(){
                ...
                HConcurrentChart.timeTicket = setInterval(function () {
                    addData(true);
            ...
            function httpCreate(){
                ...
                HCreateChart.timeTicket = setInterval(function () {
                    addData(true);
...
$(document).ready(function () {
    ...
    $(".sub-menu>.nav-item a").click(function(e){
        ...
        if(href==="#system-state"){
            ...
            //自定义时间范围
            $("#selectEd option:first-child,#selectEd1 option:first-child").hide();
